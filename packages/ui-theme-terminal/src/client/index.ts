...
/**
 * SONAR STATION palette as alias-token overrides. The presenter writes these
 * as inline CSS variables over the dark base palette, so the whole default UI
 * (and any widget registered into its slots) is recolored. Near-black
 * blue-teal canvas #060B10 under #0E1A21/#141F26 card layers, 1px #2C4853
 * blue-gray rules, pale cyan #8ED5DF phosphor labels, and the station's
 * semantic signal colors (BTR green, DEMON amber, ping red, waterfall blue).
 */
const TOKENS: ThemeTokens = {
  '--dsw-alias-bg-base': '#060b10',
  '--dsw-alias-bg-layer-1': '#0e1a21',
  '--dsw-alias-bg-layer-2': '#141f26',
  '--dsw-alias-bg-overlay': '#060b10',
  '--dsw-alias-border-l1': '#2c4853',
  '--dsw-alias-border-l2': '#4e929b',
  '--dsw-alias-brand-primary': '#8ed5df',
  '--dsw-alias-label-primary': '#8ed5df',
  '--dsw-alias-label-secondary': '#4e929b',
  '--dsw-alias-state-error-primary': '#e54344',
  '--dsw-alias-state-success-primary': '#03e877',
  '--dsw-alias-state-warn-primary': '#facd78',
  '--dsw-specific-sidebar-fill': '#0e1a21',
}
